...
export function mayachainGetAccountPaths(
  msg: core.MayachainGetAccountPaths,
): core.MayachainAccountPath[] {
  return [
    {
      addressNList: [
        0x80000000 + 44,
...
export async function mayachainGetAddress(
  ...
  const response = await transport.call(
    Messages.MessageType.MESSAGETYPE_MAYACHAINGETADDRESS,
    getAddr,
    {
