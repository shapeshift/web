...
const dogecoin = __importStar(require("./DogecoinChainAdapter"));
...
describe('DogecoinChainAdapter', () => {
    ...
    beforeEach(() => {
        args = {
            ...
            coinName: 'Dogecoin',
            chainId: types_1.KnownChainIds.DogecoinMainnet,
        };
    });
    ...
    describe('getType', () => {
        it('should return KnownChainIds.DogecoinMainnet', () => {
            ...
            expect(type).toEqual(types_1.KnownChainIds.DogecoinMainnet);
        });
    });
    describe('getAccount', () => {
        it('should return account info for a specified address', async () => {
            ...
            const expected = {
                pubkey: 'DQTjL9vfXVbMfCGM49KWeYvvvNzRPaoiFp',
                chain: types_1.KnownChainIds.DogecoinMainnet,
                balance: '150',
