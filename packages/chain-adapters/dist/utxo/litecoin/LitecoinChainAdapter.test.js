...
const litecoin = __importStar(require("./LitecoinChainAdapter"));
const testMnemonic = 'alcohol woman abuse must during monitor noble actual mixed trade anger aisle';
const VALID_CHAIN_ID = caip_1.ltcChainId;
const VALID_ASSET_ID = caip_1.ltcAssetId;
...
const getAccountMockResponse = {
    ...
    network: 'MAINNET',
    pubkey: 'zpub6sFGAsUva7JH1QSoCMk6aP92E1K5Lx8qtuQsdNeHvUzFdNi6AtsgwEVU6JrwMsfKARSVkYyN66qeiPdfGsoz3cLUVJ8uhsKX65oLvh1yBXj',
    symbol: 'LTC',
};
...
describe('LitecoinChainAdapter', () => {
    ...
    beforeEach(() => {
        args = {
            ...
            coinName: 'Litecoin',
            chainId: types_1.KnownChainIds.LitecoinMainnet,
        };
    });
    describe('constructor', () => {
        ...
        it('should use default chainId if no arg chainId provided.', () => {
            delete args.chainId;
            const chainId = new litecoin.ChainAdapter(args).getChainId();
            expect(chainId).toEqual(caip_1.ltcChainId);
        });
    });
    describe('getType', () => {
        it('should return KnownChainIds.LitecoinMainnet', () => {
            const type = new litecoin.ChainAdapter(args).getType();
            expect(type).toEqual(types_1.KnownChainIds.LitecoinMainnet);
        });
    });
    describe('getAccount', () => {
        it('should return account info for a specified address', async () => {
            ...
            const expected = {
                pubkey,
                chain: types_1.KnownChainIds.LitecoinMainnet,
                balance: '150',
    ...
    describe('getBIP44Params', () => {
        ...
        it('should properly map account types to purposes', () => {
            const accountTypes = [
                types_1.UtxoAccountType.P2pkh,
                types_1.UtxoAccountType.SegwitP2sh,
                types_1.UtxoAccountType.SegwitNative,
            ];
