...
export function MixinNativeOsmosisWalletInfo<TBase extends core.Constructor<core.HDWalletInfo>>(
  Base: TBase,
) {
  ...
  return class MixinNativeOsmosisWalletInfo extends Base implements core.OsmosisWalletInfo {
    ...
    osmosisNextAccountPath(_msg: core.OsmosisAccountPath): core.OsmosisAccountPath | undefined {
...
export function MixinNativeOsmosisWallet<TBase extends core.Constructor<NativeHDWalletBase>>(
  Base: TBase,
) {
  // eslint-disable-next-line @typescript-eslint/no-shadow
