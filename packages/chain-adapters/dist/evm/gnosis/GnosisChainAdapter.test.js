...
const gnosis = __importStar(require("./GnosisChainAdapter"));
...
describe('GnosisChainAdapter', () => {
    describe('constructor', () => {
        it('should return chainAdapter with mainnet chainId if called with no chainId', () => {
            ...
            expect(adapter.getChainId()).toEqual(caip_1.gnosisChainId);
        });
        it('should return chainAdapter with valid chainId if called with valid chainId', () => {
            const args = makeChainAdapterArgs({ chainId: types_1.KnownChainIds.GnosisMainnet });
    ...
    describe('getFeeAssetId', () => {
        it('should return the correct fee assetId', () => {
            const adapter = new gnosis.ChainAdapter(makeChainAdapterArgs());
            expect(adapter.getFeeAssetId()).toEqual(caip_1.gnosisAssetId);
        });
    });
    describe('getFeeData', () => {
        ...
        it('should sign a properly formatted txToSign object', async () => {
            ...
            const tx = {
                ...
                txToSign: {
                    ...
                    value: '0xf0',
                    to: EOA_ADDRESS,
                    chainId: Number((0, caip_1.fromChainId)(caip_1.gnosisChainId).chainReference),
                    data: '0x',
                    nonce: '0x0',
            ...
            await expect(adapter.signTransaction(tx)).resolves.toEqual('0xf8668085012a05f20082520894d8da6bf26964af9d7eed9e03e53415d37aa9604581f08081eba0287a3a5138192eec60f58abff2ffb45633ecf26fe65264b715926645b6f4191da07a61e13283f6b4332b54a9412974987e6b089a113085269c59821317eb90a36e');
        });
    ...
    describe('buildSendTransaction', () => {
        ...
        it('should return a validly formatted ETHSignTx object for a valid BuildSendTxInput parameter', async () => {
            ...
            const adapter = new gnosis.ChainAdapter(args);
            const wallet = await getWallet();
            wallet.ethGetAddress = async () => await Promise.resolve(constants_1.AddressZero);
            const tx = {
                wallet,
                accountNumber,
                to: EOA_ADDRESS,
    ...
    describe('getBIP44Params', () => {
        ...
        it('should return the correct coinType', () => {
            ...
            expect(result.coinType).toStrictEqual(Number(caip_1.ASSET_REFERENCE.Gnosis));
        });
        it('should respect accountNumber', () => {
            const testCases = [
                { purpose: 44, coinType: Number(caip_1.ASSET_REFERENCE.Gnosis), accountNumber: 0 },
                { purpose: 44, coinType: Number(caip_1.ASSET_REFERENCE.Gnosis), accountNumber: 1 },
                { purpose: 44, coinType: Number(caip_1.ASSET_REFERENCE.Gnosis), accountNumber: 2 },
            ];
