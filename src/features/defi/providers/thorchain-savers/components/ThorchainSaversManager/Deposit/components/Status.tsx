          ...
          <Row.Value>
            <Box textAlign='right'>
              <Amount.Fiat
                fontWeight='bold'
                value={bnOrZero(
                  fromBaseUnit(state.deposit.protocolFeeCryptoBaseUnit ?? '0', asset.precision),
                )
              ...
              <Amount.Crypto
                color='text.subtle'
                value={fromBaseUnit(state.deposit.protocolFeeCryptoBaseUnit ?? '0', asset.precision)}
                symbol={asset.symbol}
              />
            </Box>
          </Row.Value>
          ...
          <Row.Value>
            <Box textAlign='right'>
              <Amount.Fiat
                fontWeight='bold'
                value={bnOrZero(
                  fromBaseUnit(state.deposit.networkFeeCryptoBaseUnit ?? '0', feeAsset.precision),
                )
              ...
              <Amount.Crypto
                color='text.subtle'
                value={fromBaseUnit(state.deposit.networkFeeCryptoBaseUnit ?? '0', feeAsset.precision)}
