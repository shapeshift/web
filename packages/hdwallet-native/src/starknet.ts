...
export function MixinNativeStarknetWalletInfo<TBase extends core.Constructor<core.HDWalletInfo>>(
  Base: TBase,
) {
  return class MixinNativeStarknetWalletInfoClass extends Base implements core.StarknetWalletInfo {
    ...
    starknetGetAccountPaths(msg: core.StarknetGetAccountPaths): core.StarknetAccountPath[] {
...
export function MixinNativeStarknetWallet<TBase extends core.Constructor<NativeHDWalletBase>>(
  Base: TBase,
) {
