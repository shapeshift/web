...
export const bitcoincash: AssetWithNetworkName = {
  ...
  precision: 8,
  color: '#8BC34A',
  icon: 'https://raw.githubusercontent.com/trustwallet/assets/b7a5f12d893fcf58e0eb1dd64478f076857b720b/blockchains/bitcoincash/info/logo.png',
...
export const avax: AssetWithNetworkName = {
  ...
  icon: 'https://raw.githubusercontent.com/trustwallet/assets/b7a5f12d893fcf58e0eb1dd64478f076857b720b/blockchains/avalanchec/info/logo.png',
...
export const bnbsmartchain: AssetWithNetworkName = {
  ...
  precision: 18,
  color: '#F0B90B',
  icon: 'https://github.com/trustwallet/assets/blob/b7a5f12d893fcf58e0eb1dd64478f076857b720b/blockchains/binance/info/logo.png?raw=true',
...
export const polygon: AssetWithNetworkName = {
  ...
  precision: 18,
  color: '#8f00ff',
  icon: 'https://raw.githubusercontent.com/trustwallet/assets/b7a5f12d893fcf58e0eb1dd64478f076857b720b/blockchains/polygon/info/logo.png',
