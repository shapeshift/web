...
export const zerionMarketDataToMarketData = (zerionMarketData: ZerionMarketData): MarketData => {
  ...
  return {
    ...
    marketCap: marketCap !== undefined ? marketCap.toString() : '0',
    volume: '0', // Not available from Zerion API
    changePercent24Hr: changes.percent_1d !== undefined ? changes.percent_1d : 0,
    supply: supply !== undefined ? supply.toString() : '0',
    maxSupply: maxSupply !== undefined ? maxSupply.toString() : '0',
  }
}
