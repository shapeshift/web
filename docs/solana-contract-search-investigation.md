...
- [ ] `/src/lib/utils/solanaAddress.ts` - Create new utility
- [ ] `/src/components/TradeAssetSearch/workers/assetSearch.worker.ts` - Add contract address detection
- [ ] `/src/state/slices/common-selectors.ts` - Update global search selector
- [ ] `/src/components/TradeAssetSearch/hooks/useGetCustomTokensQuery.tsx` - Update import
