...
const validators = {
  ...
  VITE_FLOWEVM_NODE_URL: url(),
  VITE_CELO_NODE_URL: url(),
  VITE_PLUME_NODE_URL: url(),
  ...
  VITE_SEI_NODE_URL: url(),
  VITE_LINEA_NODE_URL: url(),
  VITE_SCROLL_NODE_URL: url(),
  VITE_SONIC_NODE_URL: url(),
  VITE_UNICHAIN_NODE_URL: url(),
  ...
  VITE_FEATURE_MANTLE: bool({ default: false }),
  VITE_FEATURE_INK: bool({ default: false }),
  VITE_FEATURE_MEGAETH: bool({ default: false }),
  VITE_FEATURE_BERACHAIN: bool({ default: false }),
  VITE_FEATURE_CRONOS: bool({ default: false }),
  VITE_FEATURE_KATANA: bool({ default: false }),
  VITE_FEATURE_FLOWEVM: bool({ default: false }),
  VITE_FEATURE_CELO: bool({ default: false }),
  VITE_FEATURE_PLUME: bool({ default: false }),
  ...
  VITE_FEATURE_SEI: bool({ default: false }),
  VITE_FEATURE_LINEA: bool({ default: false }),
  VITE_FEATURE_SCROLL: bool({ default: false }),
  VITE_FEATURE_SONIC: bool({ default: false }),
  VITE_FEATURE_UNICHAIN: bool({ default: false }),
  VITE_FEATURE_BOB: bool({ default: false }),
  VITE_FEATURE_MODE: bool({ default: false }),
  VITE_FEATURE_SONEIUM: bool({ default: false }),
  VITE_FEATURE_MAYACHAIN: bool({ default: false }),
  VITE_FEATURE_ZCASH: bool({ default: false }),
  VITE_FEATURE_ZRX_SWAP: bool({ default: false }),
  VITE_FEATURE_FYND_SWAP: bool({ default: false }),
  ...
  VITE_FYND_ETHEREUM_BASE_URL: url({ default: 'http://localhost:3001/v1' }),
  VITE_FEATURE_CHAINFLIP_SWAP: bool({ default: false }),
  VITE_FEATURE_CHAINFLIP_SWAP_DCA: bool({ default: false }),
  VITE_FEATURE_CHAINFLIP_LENDING: bool({ default: false }),
  ...
  VITE_FEATURE_ROBINHOOD: bool({ default: false }),
