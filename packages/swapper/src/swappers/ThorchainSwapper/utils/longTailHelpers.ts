import { avalancheChainId, bscChainId, ethChainId, fromAssetId } from '@shapeshiftmonorepo/caip'
import type { UNISWAP_V3_QUOTER_ABI } from '@shapeshiftmonorepo/contracts'
import { I_UNISWAP_V3_POOL_ABI } from '@shapeshiftmonorepo/contracts'
