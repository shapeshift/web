...
import type { CosmosGetAddressResponse } from '@shapeshiftoss/metamask-snaps-types'

import { SNAP_ID } from './common'

export function cosmosGetAccountPaths(msg: core.CosmosGetAccountPaths): core.CosmosAccountPath[] {
  return [
    {
      addressNList: [
        0x80000000 + 44,
...
export function cosmosNextAccountPath(
  _msg: core.CosmosAccountPath,
): core.CosmosAccountPath | undefined {
...
export async function cosmosGetAddress(
  ...
  return await snapCosmosGetAddress({
    snapId: SNAP_ID,
    addressParams: { addressNList: msg.addressNList },
  })
}
