...
export function MixinNativeNearWalletInfo<TBase extends core.Constructor<core.HDWalletInfo>>(
  Base: TBase,
) {
  ...
  return class MixinNativeNearWalletInfo extends Base implements core.NearWalletInfo {
    ...
    nearGetAccountPaths(msg: core.NearGetAccountPaths): core.NearAccountPath[] {
...
export function MixinNativeNearWallet<TBase extends core.Constructor<NativeHDWalletBase>>(
  Base: TBase,
) {
  // eslint-disable-next-line @typescript-eslint/no-shadow
