import { fromAssetId, mantleChainId } from '@shapeshiftoss/caip'
import { mantle } from '@shapeshiftoss/chain-adapters'
          ...
          chainAdapters: [
            [
              ...
              () => {
                ...
                return new mantle.ChainAdapter({
                  rpcUrl: getConfig().VITE_MANTLE_NODE_URL,
                  getKnownTokens,
                })
              },
            ],
