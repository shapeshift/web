...
export type FromOrXpub =
  | { from: string; xpub?: never }
  | { from?: never; xpub: string };
...
export type GetUnsignedSolanaTransactionArgs =
...
export type GetUnsignedSuiTransactionArgs = CommonGetUnsignedTransactionArgs &
  SuiAccountMetadata &
  SuiSwapperDeps;
export type GetUnsignedStarknetTransactionArgs =
...
export type GetUnsignedUtxoTransactionArgs = CommonGetUnsignedTransactionArgs &
  UtxoAccountMetadata &
  UtxoSwapperDeps;
export type GetUnsignedCosmosSdkTransactionArgs =
  CommonGetUnsignedTransactionArgs &
...
export type SwapperApi = {
  ...
  getUnsignedEvmMessage?: (
    input: GetUnsignedEvmMessageArgs,
  ) => Promise<EvmMessageToSign>;
  ...
  getUnsignedSolanaTransaction?: (
    input: GetUnsignedSolanaTransactionArgs,
  ) => Promise<SolanaSignTx>;
  getUnsignedTronTransaction?: (
    input: GetUnsignedTronTransactionArgs,
  ) => Promise<tron.TronSignTx>;
  getUnsignedSuiTransaction?: (
    input: GetUnsignedSuiTransactionArgs,
  ) => Promise<SuiSignTx>;
  getUnsignedNearTransaction?: (
    input: GetUnsignedNearTransactionArgs,
  ) => Promise<near.NearSignTx>;
  ...
  getNearTransactionFees?: (
    input: GetUnsignedNearTransactionArgs,
  ) => Promise<string>;
  getStarknetTransactionFees?: (
    input: GetUnsignedStarknetTransactionArgs,
  ) => Promise<string>;
};
...
export type MonadicSwapperAxiosService = ReturnType<
  typeof makeSwapperAxiosServiceMonadic
>;
