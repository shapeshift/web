...
const avalanche = __importStar(require("./AvalancheChainAdapter"));
...
describe('AvalancheChainAdapter', () => {
    describe('constructor', () => {
        it('should return chainAdapter with Avalanche mainnet chainId if called with no chainId', () => {
            ...
            expect(adapter.getChainId()).toEqual(caip_1.avalancheChainId);
        });
        it('should return chainAdapter with valid chainId if called with valid chainId', () => {
            const args = makeChainAdapterArgs({ chainId: types_1.KnownChainIds.AvalancheMainnet });
    ...
    describe('getFeeAssetId', () => {
        it('should return the correct fee assetId', () => {
            const adapter = new avalanche.ChainAdapter(makeChainAdapterArgs());
            expect(adapter.getFeeAssetId()).toEqual(caip_1.avalancheAssetId);
        });
    });
    describe('getFeeData', () => {
        ...
        it('should sign a properly formatted txToSign object', async () => {
            ...
            const tx = {
                ...
                txToSign: {
                    ...
                    value: '0x0',
                    to: EOA_ADDRESS,
                    chainId: Number((0, caip_1.fromChainId)(caip_1.avalancheChainId).chainReference),
            ...
            await expect(adapter.signTransaction(tx)).resolves.toEqual('0xf86e808529d41057e082c9df94d8da6bf26964af9d7eed9e03e53415d37aa9604580880000000000000000830150f7a0223295981df317a15971efd35e19cab02f680ff1185de044dd5b2914b49d83489f9e23396841e1364e2518806970d217a2019270a83d0dc2f4a2bc9e060e2e54');
        });
    ...
    describe('getBIP44Params', () => {
        ...
        it('should return the correct coinType', () => {
            ...
            expect(result.coinType).toStrictEqual(Number(caip_1.ASSET_REFERENCE.AvalancheC));
        });
        it('should respect accountNumber', () => {
            const testCases = [
                { purpose: 44, coinType: Number(caip_1.ASSET_REFERENCE.AvalancheC), accountNumber: 0 },
                { purpose: 44, coinType: Number(caip_1.ASSET_REFERENCE.AvalancheC), accountNumber: 1 },
                { purpose: 44, coinType: Number(caip_1.ASSET_REFERENCE.AvalancheC), accountNumber: 2 },
            ];
