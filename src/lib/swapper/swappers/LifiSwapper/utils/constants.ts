...
export const MIN_SAME_CHAIN_AMOUNT_THRESHOLD_USD_HUMAN = '0' // Same chain bridges can be of any amount, since fees are paid explicitly as miner fees in one chain
