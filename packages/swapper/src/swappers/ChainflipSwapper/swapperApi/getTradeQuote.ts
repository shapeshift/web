...
import type { CommonTradeQuoteInput, GetTradeRateInput, SwapperDeps } from '../../../types'
import { type TradeQuoteResult } from '../../../types'
import {
...
export const getTradeQuote = async (
  ...
  const rates = await _getTradeRate(input as unknown as GetTradeRateInput, deps)
  ...
  return rates as TradeQuoteResult
}
