  ...
  describe('Bitcoin', () => {
    ...
    test(
      ...
      async () => {
        ...
        // 0xfffffffe in little-endian is 'feffffff'. Verify it appears in the serialized tx
        // instead of the default 'ffffffff', confirming sequence was passed through.
        expect(res!.serializedTx).toContain('feffffff')
      },
      TIMEOUT,
    )
