import type { ByteArray, Uint32 } from '../../types'
import type * as Digest from '../digest'
import type { CurvePoint, RecoverableSignature, Signature } from './types'
...
export interface ECDHKey {
  ...
  ecdh(
    ...
    digestAlgorithm?: Digest.AlgorithmName<32>,
  ): Promise<NonNullable<ByteArray<32>>>
