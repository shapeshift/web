...
const SUPPORTED_CHAIN_IDS = [types_1.KnownChainIds.GnosisMainnet];
const DEFAULT_CHAIN_ID = types_1.KnownChainIds.GnosisMainnet;
class ChainAdapter extends EvmBaseAdapter_1.EvmBaseAdapter {
    ...
    getDisplayName() {
        return types_2.ChainAdapterDisplayName.Gnosis;
    }
    getName() {
        const enumIndex = Object.values(types_2.ChainAdapterDisplayName).indexOf(types_2.ChainAdapterDisplayName.Gnosis);
        return Object.keys(types_2.ChainAdapterDisplayName)[enumIndex];
    }
    getType() {
        return types_1.KnownChainIds.GnosisMainnet;
    }
    getFeeAssetId() {
        return this.assetId;
    }
...
ChainAdapter.defaultBIP44Params = {
    purpose: 44,
    coinType: Number(caip_1.ASSET_REFERENCE.Gnosis),
    accountNumber: 0,
};
