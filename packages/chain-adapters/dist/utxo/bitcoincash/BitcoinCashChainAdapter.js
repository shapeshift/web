...
const SUPPORTED_CHAIN_IDS = [types_1.KnownChainIds.BitcoinCashMainnet];
const DEFAULT_CHAIN_ID = types_1.KnownChainIds.BitcoinCashMainnet;
...
class ChainAdapter extends UtxoBaseAdapter_1.UtxoBaseAdapter {
    ...
    getDisplayName() {
        return types_2.ChainAdapterDisplayName.BitcoinCash;
    }
    getName() {
        const enumIndex = Object.values(types_2.ChainAdapterDisplayName).indexOf(types_2.ChainAdapterDisplayName.BitcoinCash);
        return Object.keys(types_2.ChainAdapterDisplayName)[enumIndex];
    }
    getType() {
        return types_1.KnownChainIds.BitcoinCashMainnet;
    }
    getFeeAssetId() {
        return this.assetId;
    }
