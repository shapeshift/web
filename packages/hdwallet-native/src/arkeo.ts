...
export function MixinNativeArkeoWalletInfo<TBase extends core.Constructor<core.HDWalletInfo>>(
  Base: TBase,
) {
  ...
  return class MixinNativeArkeoWalletInfo extends Base implements core.ArkeoWalletInfo {
    ...
    arkeoNextAccountPath(_msg: core.ArkeoAccountPath): core.ArkeoAccountPath | undefined {
...
export function MixinNativeArkeoWallet<TBase extends core.Constructor<NativeHDWalletBase>>(
  Base: TBase,
) {
  // eslint-disable-next-line @typescript-eslint/no-shadow
