...
export const CosmosEmpty = ({ assets, apy, onStakeClick, onLearnMoreClick }: FoxyEmptyProps) => {
        ...
        footer={
          <VStack spacing={4} align='center' width='100%'>
            <Button width='full' colorScheme='blue' onClick={onStakeClick}>
              <Text
                translation={['defi.modals.cosmosOverview.cta', { assetName: stakingAsset.name }]}
              />
            </Button>
