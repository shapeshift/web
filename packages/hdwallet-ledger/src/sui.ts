...
export async function suiGetAddress(
  transport: LedgerTransport,
  msg: core.SuiGetAddress,
): Promise<string> {
  ...
  try {
    ...
    const addressBytes =
      res.payload.address instanceof Uint8Array
        ? res.payload.address
...
async function suiGetPublicKey(
  transport: LedgerTransport,
  ...
  try {
    ...
    const publicKeyBytes =
      res.payload.publicKey instanceof Uint8Array
...
export function suiGetAccountPaths(msg: core.SuiGetAccountPaths): core.SuiAccountPath[] {
