import { base } from '@shapeshiftmonorepo/chain-adapters'
...
export const http = new unchained.base.V1Api(
  new unchained.base.Configuration({
    basePath: getConfig().VITE_UNCHAINED_BASE_HTTP_URL,
  }),
)
            ...
            [
              ...
              () => {
                const ws = new unchained.ws.Client<unchained.base.Tx>(
                  getConfig().VITE_UNCHAINED_BASE_WS_URL,
                )

                return new base.ChainAdapter({
                  providers: { http, ws },
                  rpcUrl: getConfig().VITE_BASE_NODE_URL,
                })
              },
            ],
          ],
