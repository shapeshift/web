    ...
    >
      <div className='ssw-settings-modal'>
        <div className='ssw-modal-header'>
          <h2 id='settings-modal-title' className='ssw-modal-title'>
            Settings
          </h2>
        ...
        <div className='ssw-settings-content'>
          <div className='ssw-settings-section'>
            ...
            <div className='ssw-slippage-options'>
              ...
              <div className={`ssw-slippage-custom ${isCustom ? 'ssw-selected' : ''}`}>
                <input
                  type='text'
                  placeholder='Custom'
            ...
            {isHighSlippage && (
              <div className={`ssw-slippage-warning ${isVeryHighSlippage ? 'ssw-error' : ''}`}>
                <svg
                  width='16'
                  height='16'
                  viewBox='0 0 24 24'
