...
export class MetaMaskMultiChainHDWalletInfo implements core.HDWalletInfo, core.ETHWalletInfo {
  ...
  public bitcoinCashGetAccountPaths(msg: core.BTCGetAccountPaths): core.BTCAccountPath[] {
    return Btc.bitcoinGetAccountPaths(msg)
  }

  public bitcoinCashNextAccountPath(_msg: core.BTCAccountPath): core.BTCAccountPath | undefined {
    // TODO: What do we do here?
    return undefined
  }
  ...
  public dogecoinGetAccountPaths(msg: core.BTCGetAccountPaths): core.BTCAccountPath[] {
    return Doge.dogecoinGetAccountPaths(msg)
  }

  public dogecoinNextAccountPath(_msg: core.BTCAccountPath): core.BTCAccountPath | undefined {
    // TODO: What do we do here?
    return undefined
  }
  ...
  public litecoinGetAccountPaths(msg: core.BTCGetAccountPaths): core.BTCAccountPath[] {
    return Litecoin.litecoinGetAccountPaths(msg)
  }

  public litecoinNextAccountPath(_msg: core.BTCAccountPath): core.BTCAccountPath | undefined {
    // TODO: What do we do here?
    return undefined
  }
  ...
  public thorchainGetAccountPaths(msg: core.ThorchainGetAccountPaths): core.ThorchainAccountPath[] {
    return Thorchain.thorchainGetAccountPaths(msg)
  }

  public thorchainNextAccountPath(
    _msg: core.ThorchainAccountPath,
  ): core.ThorchainAccountPath | undefined {
    // TODO: What do we do here?
    return undefined
  }
}
  ...
  implements core.HDWallet, core.BTCWallet, core.ETHWallet, core.CosmosWallet, core.ThorchainWallet
{
  ...
  readonly _supportsStory = true  readonly _supportsSonic = true
  ...
  publicKeysCache: Map<string, (core.PublicKey | null)[]> = new Map()
  public async getPublicKeys(msg: core.GetPublicKey[]): Promise<(core.PublicKey | null)[]> {
    ...
    const filtered = flattened.filter(x => x !== null) as core.PublicKey[]
