...
> **Not live yet.** Deposit detection is still rolling out, so the deposit screen does not yet
> advance on its own. A deposit sent to the address swaps and settles normally regardless.
