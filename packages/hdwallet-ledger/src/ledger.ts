    ...
    core.NearWalletInfo
{
  ...
  public mayachainGetAccountPaths(msg: core.MayachainGetAccountPaths): core.MayachainAccountPath[] {
  ...
  public mayachainNextAccountPath(
    _msg: core.MayachainAccountPath,
  ): core.MayachainAccountPath | undefined {
    return undefined
  }
  ...
  public tronGetAccountPaths(msg: core.TronGetAccountPaths): core.TronAccountPath[] {
  ...
  public nearGetAccountPaths(msg: core.NearGetAccountPaths): core.NearAccountPath[] {
    ...
    core.NearWallet
{
  ...
  public async getPublicKeys(msg: core.GetPublicKey[]): Promise<(core.PublicKey | null)[]> {
    ...
    const btcApps = new Set(
      btc.supportedCoins.map(x => coinToLedgerAppName(x)).filter(x => x !== undefined),
    )
  ...
  ): Promise<core.ETHSignedTypedData | null> {
    await this.validateCurrentApp('Ethereum')
