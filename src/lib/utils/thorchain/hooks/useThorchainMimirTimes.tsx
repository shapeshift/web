...
import { THORCHAIN_BLOCK_TIME_SECONDS, thorchainBlockTimeMs } from '../constants'
...
export const useThorchainMimirTimes = () => {
  const liquidityLockupTimeResult = useQuery({
    ...reactQueries.thornode.mimir(),
    staleTime: thorchainBlockTimeMs,
    select: selectLiquidityLockupTime,
  })

  const runePoolDepositMaturityTimeResult = useQuery({
    ...reactQueries.thornode.mimir(),
    staleTime: thorchainBlockTimeMs,
    select: selectRunePoolMaturityTime,
  })

  return {
    liquidityLockupTimeResult,
    runePoolDepositMaturityTimeResult,
  }
}
