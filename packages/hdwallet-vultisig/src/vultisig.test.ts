...
import type { VultisigSolanaProvider, VultisigUtxoProvider } from './types'
...
describe('VultisigHDWallet', () => {
  ...
  describe('Ethereum', () => {
    it('ethGetAddress returns a valid address', async () => {
      wallet.evmProvider = {
        request: vi.fn().mockReturnValue(['0x73d0385F4d8E00C5e6504C6030F47BF6212736A8']),
      }
    ...
    it('ethSendTx returns a valid hash', async () => {
      wallet.evmProvider = {
        request: vi.fn().mockReturnValue('0x123'),
      }
    ...
    it('ethSendTx returns null on error', async () => {
      wallet.evmProvider = {
        request: vi.fn().mockRejectedValue(new Error('An Error has occurred')),
      }
  ...
  describe('Bitcoin', () => {
    it('btcGetAddress returns a valid address', async () => {
      wallet.bitcoinProvider = {
        request: vi.fn().mockReturnValue(['bc1q9sjm947kn2hz84syykmem7dshvevm8xm5dkrpg']),
