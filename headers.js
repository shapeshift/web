...
const cspMeta = Object.entries({
  ...
  'connect-src': [
    ...
    'https://test-api.yearn.network/v1/chains/1/vaults/getDynamic',
    'https://test-api.yearn.network/v1/chains/1/strategies/metadata/get',
    'https://test-api.yearn.network/v1/chains/1/vaults/get',
    'https://test-api.yearn.network/v1/chains/1/vaults/earnings/get',
