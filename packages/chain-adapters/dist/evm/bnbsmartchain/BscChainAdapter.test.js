...
const bsc = __importStar(require("./BscChainAdapter"));
...
describe('BscChainAdapter', () => {
    describe('constructor', () => {
        it('should return chainAdapter with mainnet chainId if called with no chainId', () => {
            ...
            expect(adapter.getChainId()).toEqual(caip_1.bscChainId);
        });
        it('should return chainAdapter with valid chainId if called with valid chainId', () => {
            const args = makeChainAdapterArgs({ chainId: types_1.KnownChainIds.BnbSmartChainMainnet });
    ...
    describe('getFeeAssetId', () => {
        it('should return the correct fee assetId', () => {
            const adapter = new bsc.ChainAdapter(makeChainAdapterArgs());
            expect(adapter.getFeeAssetId()).toEqual(caip_1.bscAssetId);
        });
    });
    describe('getFeeData', () => {
        ...
        it('should sign a properly formatted txToSign object', async () => {
            ...
            const tx = {
                ...
                txToSign: {
                    ...
                    value: '0xf0',
                    to: EOA_ADDRESS,
                    chainId: Number((0, caip_1.fromChainId)(caip_1.bscChainId).chainReference),
                    data: '0x',
                    nonce: '0x0',
            ...
            await expect(adapter.signTransaction(tx)).resolves.toEqual('0xf8668085012a05f20082520894d8da6bf26964af9d7eed9e03e53415d37aa9604581f0808193a024e66cc183b9b3e72267ed5db7072789419300d2cb58ccb5f69fc5209f440feaa079cf9b1f0ffb0320d74f809504ced656b064680976ab332bc7a9fb9e4473c8d4');
        });
    ...
    describe('getBIP44Params', () => {
        ...
        it('should return the correct coinType', () => {
            ...
            expect(result.coinType).toStrictEqual(Number(caip_1.ASSET_REFERENCE.BnbSmartChain));
        });
        it('should respect accountNumber', () => {
            const testCases = [
                { purpose: 44, coinType: Number(caip_1.ASSET_REFERENCE.BnbSmartChain), accountNumber: 0 },
                { purpose: 44, coinType: Number(caip_1.ASSET_REFERENCE.BnbSmartChain), accountNumber: 1 },
                { purpose: 44, coinType: Number(caip_1.ASSET_REFERENCE.BnbSmartChain), accountNumber: 2 },
            ];
