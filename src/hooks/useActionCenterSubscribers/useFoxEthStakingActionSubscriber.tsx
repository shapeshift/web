...
type UseEvergreenDepositActionSubscriberProps = {
  onDrawerOpen: () => void
...
export const useEvergreenDepositActionSubscriber = ({
  onDrawerOpen,
  isDrawerOpen,
}: UseEvergreenDepositActionSubscriberProps) => {
  ...
  }, [pendingEvergreenActions, isConnected, dispatch, toast, onDrawerOpen, txById])
}
