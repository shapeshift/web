...
const assets: Asset[] = [
  ...
  },
  {
    ...
    precision: 8,
    color: '#FFFFFF',
    icon: 'https://assets.coingecko.com/coins/images/1/thumb/bitcoin.png?1696501400',
  ...
  },
  {
    ...
    iconLarge: 'https://assets.coingecko.com/coins/images/17197/large/aAMMDAI_2x.png?1626940032',
    explorer: 'https://etherscan.io',
    explorerTxLink: 'https://etherscan.io/tx/',
    explorerAddressLink: 'https://etherscan.io/address/',
    symbol: 'AAMMDAI',
