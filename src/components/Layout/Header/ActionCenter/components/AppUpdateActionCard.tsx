...
import { AppUpdateDetails } from './Details/AppUpdateDetails'

import { Amount } from '@/components/Amount/Amount'
import { AssetIconWithBadge } from '@/components/AssetIconWithBadge'
import type { OrderToCancel } from '@/components/MultiHopTrade/components/AppUpdate/types'
...
export const AppUpdateActionCard = ({
  isCollapsable = true,
  defaultIsOpen = false,
  onCancelOrder,
  order,
        ...
        <Stack spacing={0} width='full'>
          ...
          <Collapse in={isOpen}>
            <Card bg='transparent' mt={4}>
              <CardBody px={0} py={0}>
                <AppUpdateDetails action={action} order={order} onCancelOrder={onCancelOrder} />
              </CardBody>
            </Card>
          </Collapse>
        </Stack>
