      ...
      if (contractAddress === ETH_FOX_STAKING_EVERGREEN_CONTRACT && asset && accountId) {
        ...
        appDispatch(
          actionSlice.actions.upsertAction({
            ...
            transactionMetadata: {
              displayType: GenericTransactionDisplayType.ETHFOX,
              txHash: txid,
              chainId: asset.chainId,
              accountId,
              assetId: asset.assetId,
              message: translate(`actionCenter.deposit.pending`, {
                amount: fromBaseUnit(state.deposit.cryptoAmount, asset.precision),
              }),
            },
          }),
        )
