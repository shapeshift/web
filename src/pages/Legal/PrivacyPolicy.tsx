import { Button, DarkMode, Flex, Link } from '@chakra-ui/react'
      ...
      <Flex px={{ base: 2, lg: 4 }} direction={'column'} rowGap={4}>
        <DarkMode>
          ...
          <RawText as='p'>
            ...
            this notice can be found <Link href='#0'><RawText as='strong'>here</RawText></Link> Your continued use of the Platform after
            any change to this notice constitutes your acceptance of such change. If you do not
            agree to any portion of this notice, then you should not use or access (or continue to
            access) the Platform.
          </RawText>
          <RawText as='p'>
          ...
          <RawText as='dl' display={'flex'} flexDirection={'column'} rowGap={4}>
            ...
            <RawText as='dd' marginInlineStart={{ base: 2, lg: 4 }}>
              ...
              <Link href='http://www.pendo.io/'><RawText as='strong'>Pendo</RawText></Link>. You can see Pendo's data privacy and
              security practices <Link href='https://www.pendo.io/data-privacy-security/'><RawText as='strong'>here</RawText></Link>. The
              Alpha is an opt-in version of the Platform, and your use of the Alpha constitutes your
              opt-in to the data collection practices outlined in this subsection. Any data
              processing of user data on the Alpha is thus based on your consent.
            </RawText>
          </RawText>
          <RawText as='p'>
            ...
            <Link href='https://www.zendesk.com/company/customers-partners/privacy-policy/'><RawText as='strong'>here</RawText></Link>
            and Zendeks's cookie policy can be found{' '}
            <Link href='https://www.zendesk.com/company/customers-partners/cookie-policy/'><RawText as='strong'>here</RawText></Link>.
          </RawText>
          <RawText as='p'>
          ...
          <RawText as='p'>
            ...
            <Link href='https://discord.com/invite/shapeshift'><RawText as='strong'>here</RawText></Link>.
          </RawText>
        </DarkMode>
      </Flex>
    </Page>
