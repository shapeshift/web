...
export const bitcoin: AssetWithNetworkName = {
  ...
  iconLarge: 'https://assets.coingecko.com/coins/images/1/large/bitcoin.png?1696501400',
...
export const dogecoin: AssetWithNetworkName = {
  ...
  iconLarge: 'https://assets.coingecko.com/coins/images/5/large/dogecoin.png?1696501409',
  explorer: 'https://live.blockcypher.com',
...
export const litecoin: AssetWithNetworkName = {
  ...
  precision: 8,
  color: '#B8B8B8',
  icon: 'https://raw.githubusercontent.com/trustwallet/assets/32e51d582a890b3dd3135fe3ee7c20c2fd699a6d/blockchains/litecoin/info/logo.png',
  iconLarge:
    'https://raw.githubusercontent.com/trustwallet/assets/32e51d582a890b3dd3135fe3ee7c20c2fd699a6d/blockchains/litecoin/info/logo.png',
  explorer: 'https://live.blockcypher.com',
...
export const atom: AssetWithNetworkName = {
  ...
  precision: 6,
  color: '#303F9F',
  icon: 'https://coin-images.coingecko.com/coins/images/1481/standard/cosmos_hub.png?1696502525',
  iconLarge: 'https://coin-images.coingecko.com/coins/images/1481/large/cosmos_hub.png?1696502525',
...
export const thorchain: AssetWithNetworkName = {
  ...
  precision: 8,
  color: '#33FF99',
  icon: 'https://coin-images.coingecko.com/coins/images/6595/standard/Rune200x200.png?1696506946',
  iconLarge: 'https://coin-images.coingecko.com/coins/images/6595/large/Rune200x200.png?1696506946',
...
export const bnbsmartchain: AssetWithNetworkName = {
  ...
  iconLarge: 'https://assets.coingecko.com/coins/images/825/large/bnb-icon2_2x.png?1696501970',
...
export const polygon: AssetWithNetworkName = {
  ...
  precision: 18,
  color: '#8f00ff',
  icon: 'https://assets.coingecko.com/coins/images/4713/standard/matic-token-icon.png?1624446912',
  iconLarge: 'https://assets.coingecko.com/coins/images/4713/large/matic-token-icon.png?1624446912',
...
export const gnosis: AssetWithNetworkName = {
  ...
  precision: 18,
  color: '#33765c',
  icon: 'https://assets.coingecko.com/coins/images/11062/standard/Identity-Primary-DarkBG.png?1638372986',
  iconLarge:
