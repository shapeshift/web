...
const SUPPORTED_CHAIN_IDS = [types_1.KnownChainIds.BitcoinMainnet];
const DEFAULT_CHAIN_ID = types_1.KnownChainIds.BitcoinMainnet;
...
class ChainAdapter extends UtxoBaseAdapter_1.UtxoBaseAdapter {
    ...
    getDisplayName() {
        return types_2.ChainAdapterDisplayName.Bitcoin;
    }
    getName() {
        const enumIndex = Object.values(types_2.ChainAdapterDisplayName).indexOf(types_2.ChainAdapterDisplayName.Bitcoin);
        return Object.keys(types_2.ChainAdapterDisplayName)[enumIndex];
    }
    getType() {
        return types_1.KnownChainIds.BitcoinMainnet;
    }
    getFeeAssetId() {
        return this.assetId;
    }
