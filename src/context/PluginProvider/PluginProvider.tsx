...
export const PluginProvider = ({ children }: PluginProviderProps): JSX.Element => {
  ...
  useEffect(() => {
    ...
    const _supportedChains = Object.values<ChainId>(KnownChainIds).filter(chainId => {
      ...
      if (!featureFlags.Abstract && chainId === KnownChainIds.AbstractMainnet) return false
      ...
      if (!featureFlags.Robinhood && chainId === KnownChainIds.RobinhoodMainnet) return false
      return true
    })
