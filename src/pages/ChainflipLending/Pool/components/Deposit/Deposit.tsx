...
export const Deposit = memo(({ assetId: initialAssetId }: DepositProps) => {
  ...
  return (
    <DepositMachineCtx.Provider key={activeAssetId} options={{ input }}>
      <DepositContent assetId={activeAssetId} onAssetChange={setActiveAssetId} />
    </DepositMachineCtx.Provider>
  )
})

const DepositContent = memo(
