...
import type { CosmosWallet, CosmosWalletInfo } from './cosmos'
import type { DebugLinkWallet } from './debuglink'
import type { EosWallet, EosWalletInfo } from './eos'
import type { ETHWallet, ETHWalletInfo } from './ethereum'
import type { KavaWallet, KavaWalletInfo } from './kava'
import type { MayachainWallet, MayachainWalletInfo } from './mayachain'
import type { OsmosisWallet, OsmosisWalletInfo } from './osmosis'
import type { RippleWallet, RippleWalletInfo } from './ripple'
import type { SecretWallet, SecretWalletInfo } from './secret'
import type { SolanaWallet, SolanaWalletInfo } from './solana'
import type { StarknetWallet, StarknetWalletInfo } from './starknet'
import type { SuiWallet, SuiWalletInfo } from './sui'
...
export function supportsLinea(wallet: HDWallet): wallet is ETHWallet {
  return isObject(wallet) && (wallet as any)._supportsLinea
}
...
export function supportsSoneium(wallet: HDWallet): wallet is ETHWallet {
  return isObject(wallet) && (wallet as any)._supportsSoneium
}

export function supportsCitrea(wallet: HDWallet): wallet is ETHWallet {
  return isObject(wallet) && (wallet as any)._supportsCitrea
}
