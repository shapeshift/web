    ...
    core.MayachainWalletInfo
{
  ...
  public binanceGetAccountPaths(msg: core.BinanceGetAccountPaths): core.BinanceAccountPath[] {
    ...
    core.DebugLinkWallet
{
  ...
  readonly _supportsStory = false  readonly _supportsSonic = false
  ...
  public async getPublicKeys(
    getPublicKeys: core.GetPublicKey[],
    ...
    for (let i = 0; i < getPublicKeys.length; i++) {
      ...
      GPK.setScriptType(
        translateInputScriptType(scriptType || core.BTCInputScriptType.SpendAddress),
      )
  ...
  public async getNumCoins(): Promise<number> {
    ...
    return core.mustBeDefined(
      (core.mustBeDefined(response.proto) as Messages.CoinTable).getNumCoins(),
    )
  }
