...
export const Approve: React.FC<FoxFarmingApproveProps> = ({ accountId, onNext }) => {
  ...
  return (
    <ReusableApprove
      ...
      preFooter={preFooter}
      providerIcon='https://raw.githubusercontent.com/trustwallet/assets/b7a5f12d893fcf58e0eb1dd64478f076857b720b/blockchains/ethereum/assets/0xc770EEfAd204B5180dF6a14Ee197D99d808ee52d/logo.png'
