...
const polygon = __importStar(require("./PolygonChainAdapter"));
...
describe('PolygonChainAdapter', () => {
    describe('constructor', () => {
        it('should return chainAdapter with mainnet chainId if called with no chainId', () => {
            ...
            expect(adapter.getChainId()).toEqual(caip_1.polygonChainId);
        });
        it('should return chainAdapter with valid chainId if called with valid chainId', () => {
            const args = makeChainAdapterArgs({ chainId: types_1.KnownChainIds.PolygonMainnet });
    ...
    describe('getFeeAssetId', () => {
        it('should return the correct fee assetId', () => {
            const adapter = new polygon.ChainAdapter(makeChainAdapterArgs());
            expect(adapter.getFeeAssetId()).toEqual(caip_1.polygonAssetId);
        });
    });
    describe('getFeeData', () => {
        ...
        it('should sign a properly formatted txToSign object', async () => {
            ...
            const tx = {
                ...
                txToSign: {
                    ...
                    value: '0xf0',
                    to: EOA_ADDRESS,
                    chainId: Number((0, caip_1.fromChainId)(caip_1.polygonChainId).chainReference),
                    data: '0x',
                    nonce: '0x0',
            ...
            await expect(adapter.signTransaction(tx)).resolves.toEqual('0xf8678085012a05f20082520894d8da6bf26964af9d7eed9e03e53415d37aa9604581f080820136a01d0f5eaf174310462ce9a3db0fd75a6133758a29b4bf3073099b156084697d00a0066f4b117b1c7acbcbb4d9491a3f9528f8fa6fdf24193a33d33235a7a521df33');
        });
    ...
    describe('getBIP44Params', () => {
        ...
        it('should return the correct coinType', () => {
            ...
            expect(result.coinType).toStrictEqual(Number(caip_1.ASSET_REFERENCE.Polygon));
        });
        it('should respect accountNumber', () => {
            const testCases = [
                { purpose: 44, coinType: Number(caip_1.ASSET_REFERENCE.Polygon), accountNumber: 0 },
                { purpose: 44, coinType: Number(caip_1.ASSET_REFERENCE.Polygon), accountNumber: 1 },
                { purpose: 44, coinType: Number(caip_1.ASSET_REFERENCE.Polygon), accountNumber: 2 },
            ];
