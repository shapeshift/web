...
export interface StarknetWalletInfo extends HDWalletInfo {
  ...
  starknetGetAccountPaths(msg: StarknetGetAccountPaths): StarknetAccountPath[]
...
export function starknetGetAccountPaths(msg: StarknetGetAccountPaths): StarknetAccountPath[] {
