...
import { initialState, reducer } from './StakingWithdrawReducer'

const moduleLogger = logger.child({
  namespace: ['DeFi', 'Providers', 'Osmosis', 'Staking', 'OsmosisStakingWithdraw'],
})

type OsmosisStakingWithdrawProps = {
  accountId: AccountId | undefined
  onAccountIdChange: AccountDropdownProps['onChange']
}
export const OsmosisStakingWithdraw: React.FC<OsmosisStakingWithdrawProps> = ({
  ...
  return (
    <StakingWithdrawContext.Provider value={{ state, dispatch }}>
      <DefiModalContent>
        <DefiModalHeader
          onBack={handleBack}
    ...
    </StakingWithdrawContext.Provider>
  )
}
