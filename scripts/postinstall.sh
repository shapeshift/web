...
yarn patch-package
yarn typechain src/state/slices/opportunitiesSlice/resolvers/uniV2/abis/*.json --target=ethers-v5 --out-dir ./src/state/slices/opportunitiesSlice/resolvers/uniV2/contracts
