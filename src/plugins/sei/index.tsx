import { fromAssetId, seiChainId } from '@shapeshiftoss/caip'
import { sei } from '@shapeshiftoss/chain-adapters'
          ...
          chainAdapters: [
            [
              ...
              () => {
                ...
                return new sei.ChainAdapter({
                  rpcUrl: getConfig().VITE_SEI_NODE_URL,
                  getKnownTokens,
                })
              },
            ],
