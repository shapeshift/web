...
import {
    ...
    OptimismGasEstimateFromJSON,
    OptimismGasEstimateToJSON,
    OptimismGasFeesFromJSON,
    OptimismGasFeesToJSON,
    SendTxBodyFromJSON,
    SendTxBodyToJSON,
...
export class V1Api extends runtime.BaseAPI {
     ...
     */
    async estimateGasRaw(requestParameters: EstimateGasRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OptimismGasEstimate>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => OptimismGasEstimateFromJSON(jsonValue));
    }

    /**
     * Get the estimated gas cost of a transaction
     */
    async estimateGas(requestParameters: EstimateGasRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OptimismGasEstimate> {
     ...
     */
    async getGasFeesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OptimismGasFees>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => OptimismGasFeesFromJSON(jsonValue));
    }

    /**
     * Get the current recommended gas fees to use in a transaction  * `l1GasPrice` = l1BaseFee * scalar
     */
    async getGasFees(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OptimismGasFees> {
