 ...
 */
export type LoggerMethod = ((arg1: Arg1, arg2?: Arg2, arg3?: Arg3) => void) | ((message: string) => void) | ((fields: Record<string, unknown>, message: string) => void) | ((e: unknown, fields: Record<string, unknown>, message: string) => void) | ((e: unknown, message: string) => void);
