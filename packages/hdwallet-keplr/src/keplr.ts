...
export class KeplrHDWalletInfo
  implements core.HDWalletInfo, core.CosmosWalletInfo, core.OsmosisWalletInfo
{
  ...
  public osmosisNextAccountPath(
    _msg: core.OsmosisAccountPath,
  ): core.OsmosisAccountPath | undefined {
    return undefined
  }
}
...
export class KeplrHDWallet implements core.HDWallet, core.CosmosWallet, core.OsmosisWallet {
  ...
  public async initialize(networks: ChainReference[] = []): Promise<void> {
    try {
      if (!window.keplr) {
  ...
  public async getPublicKeys(
    ...
    const keys: (core.PublicKey | null)[] = []
