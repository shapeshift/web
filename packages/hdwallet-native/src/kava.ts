...
export function MixinNativeKavaWalletInfo<TBase extends core.Constructor<core.HDWalletInfo>>(
  Base: TBase,
) {
  ...
  return class MixinNativeKavaWalletInfo extends Base implements core.KavaWalletInfo {
    ...
    kavaNextAccountPath(_msg: core.KavaAccountPath): core.KavaAccountPath | undefined {
...
export function MixinNativeKavaWallet<TBase extends core.Constructor<NativeHDWalletBase>>(
  Base: TBase,
) {
  // eslint-disable-next-line @typescript-eslint/no-shadow
