...
export type TxMetadata = bep20.TxMetadata | cowswap.TxMetadata | erc20.TxMetadata | foxy.TxMetadata | thor.TxMetadata | uniV2.TxMetadata | weth.TxMetadata | zrx.TxMetadata | nft.TxMetadata;
