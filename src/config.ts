...
const validators = {
  ...
  VITE_BNBSMARTCHAIN_NODE_URL_FALLBACK_1: url({ default: '' }),
  VITE_BNBSMARTCHAIN_NODE_URL_FALLBACK_2: url({ default: '' }),
  VITE_BNBSMARTCHAIN_NODE_URL_FALLBACK_3: url({ default: '' }),
