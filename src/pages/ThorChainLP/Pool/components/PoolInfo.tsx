    ...
    <>
      <Flex gap={4} alignItems='center'>
        ...
        <Tag colorScheme='green'>
          <Amount.Percent value='0.2' suffix='APY' />
        </Tag>
      </Flex>
      <Flex flexWrap='wrap' gap={4} mx={-2}>
        <Card borderRadius='full'>
          <Flex gap={2} pl={2} pr={3} py={2} alignItems='center'>
            ...
            <Amount.Fiat value='100' prefix='1 USDC =' fontSize='xs' fontWeight='medium' />
          </Flex>
        </Card>
        <Card borderRadius='full'>
          <Flex gap={2} pl={2} pr={3} py={2} alignItems='center'>
            <AssetIcon size='xs' assetId={ethAssetId} />
            <Amount.Fiat value='100' prefix='1 ETH =' fontSize='xs' fontWeight='medium' />
          </Flex>
        </Card>
      </Flex>
      <Flex flexWrap='wrap' gap={12}>
        <Stack spacing={0} flex={1}>
          <Flex alignItems='center' gap={2}>
            <Amount.Fiat fontSize='xl' value='100' fontWeight='medium' />
