...
import type { ThorchainGetAddressResponse } from '@shapeshiftoss/metamask-snaps-types'

import { SNAP_ID } from './common'

export function thorchainGetAccountPaths(
  msg: core.ThorchainGetAccountPaths,
...
export function thorchainNextAccountPath(
...
export async function thorchainGetAddress(
  ...
  return await snapThorchainGetAddress({
    snapId: SNAP_ID,
