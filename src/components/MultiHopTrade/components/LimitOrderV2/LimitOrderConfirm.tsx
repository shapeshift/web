  ...
  const detail = useMemo(() => {
    switch (orderSubmissionState) {
      case LimitOrderSubmissionState.AwaitingAllowanceApproval:
        const allowanceApprovalNetworkFeeCryptoPrecision = fromBaseUnit(approvalNetworkFeeCryptoBaseUnit ?? '0', feeAsset?.precision ?? 0)
      ...
      case LimitOrderSubmissionState.AwaitingAllowanceReset:
        const allowanceResetNetworkFeeCryptoPrecision = fromBaseUnit(allowanceResetNetworkFeeCryptoBaseUnit ?? '0', feeAsset?.precision ?? 0)
