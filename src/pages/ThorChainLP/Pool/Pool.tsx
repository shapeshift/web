...
export const Pool = () => {
  ...
  const { data: volume24hChange } = useQuery({
    queryKey: ['thorchainPoolVolume24hChange', foundPool?.assetId ?? ''],
    queryFn: () => (foundPool ? get24hVolumeChangePercentage(foundPool.assetId) : 0),
  })
          ...
          <Card>
            ...
            >
              <PoolInfo
                ...
                volume24hChange={volume24hChange ?? 0}
                fees24h={fees24h ?? '0'}
