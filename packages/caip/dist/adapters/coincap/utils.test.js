...
describe('adapters:coincap:utils', () => {
    describe('parseEthData', () => {
        it('can parse eth data', () => {
            const result = (0, utils_2.parseEthData)([makeEthMockCoincapResponse(), makeFoxMockCoincapResponse()]);
            const expected = {
    ...
    describe('writeFiles', () => {
        it('can writeFiles', async () => {
            ...
            expect(fs_1.default.promises.writeFile).toBeCalledWith('./src/adapters/coincap/generated/foo/adapter.json', fooAssetIds);
            expect(fs_1.default.promises.writeFile).toBeCalledWith('./src/adapters/coincap/generated/bar/adapter.json', barAssetIds);
