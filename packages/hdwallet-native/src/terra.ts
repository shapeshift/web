...
export function MixinNativeTerraWalletInfo<TBase extends core.Constructor<core.HDWalletInfo>>(
  Base: TBase,
) {
  ...
  return class MixinNativeTerraWalletInfo extends Base implements core.TerraWalletInfo {
    ...
    terraNextAccountPath(_msg: core.TerraAccountPath): core.TerraAccountPath | undefined {
...
export function MixinNativeTerraWallet<TBase extends core.Constructor<NativeHDWalletBase>>(
  Base: TBase,
) {
  // eslint-disable-next-line @typescript-eslint/no-shadow
