  ...
  describe('Eos', () => {
    ...
    test.skip(
      ...
      async () => {
        ...
        expect(core.toHexString(res.hash)).toEqual(
          '86a946cd06ddac53c256700ef8bfeed4d1f72512909400df597c8d594d1b0591',
        )
      },
      TIMEOUT,
    )
    ...
    test.skip(
      ...
      async () => {
        ...
        expect(core.toHexString(res.hash)).toEqual(
          'd34082c1b4c6f578ef46500e30dcdc4987715d088323da8f2fb2b296f9db7b12',
        )
      },
      TIMEOUT,
    )
