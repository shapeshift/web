...
export function MixinNativeSecretWalletInfo<TBase extends core.Constructor<core.HDWalletInfo>>(
  Base: TBase,
) {
  ...
  return class MixinNativeSecretWalletInfo extends Base implements core.SecretWalletInfo {
    ...
    secretNextAccountPath(_msg: core.SecretAccountPath): core.SecretAccountPath | undefined {
...
export function MixinNativeSecretWallet<TBase extends core.Constructor<NativeHDWalletBase>>(
  Base: TBase,
) {
  // eslint-disable-next-line @typescript-eslint/no-shadow
