import { btcAssetId, fromAssetId, isAssetReference } from '@shapeshiftoss/caip'
import type { Asset } from '@shapeshiftoss/types'
import type { Address } from 'viem'

import { isNativeEvmAsset } from '../../utils/helpers/helpers'
import { DEFAULT_RELAY_BTC_TOKEN_ADDRESS, DEFAULT_RELAY_EVM_TOKEN_ADDRESS } from '../constant'
