...
export const getServerConfig = (): SwapperConfig => ({
  VITE_UNCHAINED_THORCHAIN_HTTP_URL: process.env.UNCHAINED_THORCHAIN_HTTP_URL || 'https://api.thorchain.shapeshift.com',
  VITE_UNCHAINED_MAYACHAIN_HTTP_URL: process.env.UNCHAINED_MAYACHAIN_HTTP_URL || 'https://api.mayachain.shapeshift.com',
  VITE_UNCHAINED_COSMOS_HTTP_URL: process.env.UNCHAINED_COSMOS_HTTP_URL || 'https://api.cosmos.shapeshift.com',
  ...
  VITE_FEATURE_THORCHAINSWAP_L1_TO_LONGTAIL: process.env.FEATURE_THORCHAINSWAP_L1_TO_LONGTAIL === 'true',
  VITE_THORCHAIN_MIDGARD_URL: process.env.THORCHAIN_MIDGARD_URL || 'https://midgard.thorchain.info/v2',
  VITE_MAYACHAIN_MIDGARD_URL: process.env.MAYACHAIN_MIDGARD_URL || 'https://midgard.mayachain.info/v2',
  VITE_UNCHAINED_BITCOIN_HTTP_URL: process.env.UNCHAINED_BITCOIN_HTTP_URL || 'https://api.bitcoin.shapeshift.com',
  VITE_UNCHAINED_DOGECOIN_HTTP_URL: process.env.UNCHAINED_DOGECOIN_HTTP_URL || 'https://api.dogecoin.shapeshift.com',
  VITE_UNCHAINED_LITECOIN_HTTP_URL: process.env.UNCHAINED_LITECOIN_HTTP_URL || 'https://api.litecoin.shapeshift.com',
  VITE_UNCHAINED_BITCOINCASH_HTTP_URL: process.env.UNCHAINED_BITCOINCASH_HTTP_URL || 'https://api.bitcoincash.shapeshift.com',
  VITE_UNCHAINED_ETHEREUM_HTTP_URL: process.env.UNCHAINED_ETHEREUM_HTTP_URL || 'https://api.ethereum.shapeshift.com',
  VITE_UNCHAINED_AVALANCHE_HTTP_URL: process.env.UNCHAINED_AVALANCHE_HTTP_URL || 'https://api.avalanche.shapeshift.com',
  VITE_UNCHAINED_BNBSMARTCHAIN_HTTP_URL: process.env.UNCHAINED_BNBSMARTCHAIN_HTTP_URL || 'https://api.bnbsmartchain.shapeshift.com',
  VITE_UNCHAINED_BASE_HTTP_URL: process.env.UNCHAINED_BASE_HTTP_URL || 'https://api.base.shapeshift.com',
