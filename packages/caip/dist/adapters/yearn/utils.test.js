...
const vault1 = {
    ...
    metadata: {
        ...
        displayIcon: 'https://raw.githack.com/yearn/yearn-assets/master/icons/multichain-tokens/1/0x5B3b5DF2BF2B6543f78e053bD91C4Bdd820929f1/logo-128.png',
...
describe('adapters:yearn:utils', () => {
    describe('yearn: parseEthData', () => {
        it('can parse eth data', () => {
            const result = (0, utils_1.parseEthData)([vault1, vault2, vault3]);
            const expected = {
                [`eip155:1/erc20:${(0, toLower_1.default)(vault1.address)}`]: vault1.address,
                [`eip155:1/erc20:${(0, toLower_1.default)(vault2.address)}`]: vault2.address,
                [`eip155:1/erc20:${(0, toLower_1.default)(vault3.address)}`]: vault3.address,
            };
    ...
    describe('writeFiles', () => {
        it('can writeFiles', async () => {
            ...
            await (0, utils_1.writeFiles)(data);
            expect(fs_1.default.promises.writeFile).toBeCalledWith('./src/adapters/yearn/generated/foo/adapter.json', fooAssetIds);
