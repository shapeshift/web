...
const bitcoin = __importStar(require("./BitcoinChainAdapter"));
...
const getAccountMockResponse = {
    ...
    network: 'MAINNET',
    pubkey: 'zpub6qSSRL9wLd6LNee7qjDEuULWccP5Vbm5nuX4geBu8zMCQBWsF5Jo5UswLVxFzcbCMr2yQPG27ZhDs1cUGKVH1RmqkG1PFHkEXyHG7EV3ogY',
    symbol: 'BTC',
};
...
describe('BitcoinChainAdapter', () => {
    ...
    beforeEach(() => {
        args = {
            ...
            coinName: 'Bitcoin',
            chainId: types_1.KnownChainIds.BitcoinMainnet,
        };
    });
    ...
    describe('getType', () => {
        it('should return KnownChainIds.BitcoinMainnet', () => {
            ...
            expect(type).toEqual(types_1.KnownChainIds.BitcoinMainnet);
        });
    });
    describe('getAccount', () => {
        it('should return account info for a specified address', async () => {
            ...
            const expected = {
                pubkey: '1EjpFGTWJ9CGRJUMA3SdQSdigxM31aXAFx',
                chain: types_1.KnownChainIds.BitcoinMainnet,
                balance: '150',
    ...
    describe('buildSendTransaction', () => {
        it('should return a formatted BTCSignTx object for a valid BuildSendTxInput parameter', async () => {
            ...
            const txInput = {
                ...
                wallet,
                chainSpecific: {
                    accountType: types_1.UtxoAccountType.SegwitNative,
                    satoshiPerByte: '1',
                },
            };
