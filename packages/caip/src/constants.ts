...
export const storyAssetId: AssetId = 'eip155:1514/slip44:60'export const zkSyncEraAssetId: AssetId = 'eip155:324/slip44:60'
...
export const storyChainId: ChainId = 'eip155:1514'export const zkSyncEraChainId: ChainId = 'eip155:324'
...
export const CHAIN_REFERENCE = {
  ...
  StoryMainnet: '1514', // https://docs.story.foundation  ZkSyncEraMainnet: '324', // https://docs.zksync.io
...
export const ASSET_REFERENCE = {
  ...
  Story: '60', // evm chain which uses ethereum derivation path as common practice  ZkSyncEra: '60', // evm chain which uses ethereum derivation path as common practice
...
export const VALID_CHAIN_IDS: ValidChainMap = Object.freeze({
  ...
  [CHAIN_NAMESPACE.Evm]: [
    ...
    CHAIN_REFERENCE.StoryMainnet,    CHAIN_REFERENCE.ZkSyncEraMainnet,
