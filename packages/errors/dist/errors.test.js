...
describe.each `
  TestError            | code
  ${ErrorWithDetails_1.ErrorWithDetails}  | ${'ERR_UNKNOWN'}
  ${ForbiddenError_1.ForbiddenError}    | ${'ERR_FORBIDDEN'}
  ${NotFoundError_1.NotFoundError}     | ${'ERR_NOT_FOUND'}
  ${RateLimitError_1.RateLimitError}    | ${'ERR_RATE_LIMIT'}
  ${UnauthorizedError_1.UnauthorizedError} | ${'ERR_UNAUTHORIZED'}
  ${ValidationError_1.ValidationError}   | ${'ERR_VALIDATION'}
