...
export const csp: Csp = {
  'connect-src': [
    ...
    // @shapeshiftoss/market-service@v4.5.0: https://github.com/shapeshift/lib/blob/9a301396646089fdc1c08626d82868461e46221e/packages/market-service/src/coingecko/coingecko.ts#L42
