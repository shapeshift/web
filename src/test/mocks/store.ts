...
export const mockStore: ReduxState = {
  ...
  getTradeQuoteApi: mockApiFactory('getTradeQuoteApi' as const),
  getBestSwapperApi: mockApiFactory('getBestSwapperApi' as const),
  getUsdRateApi: mockApiFactory('getUsdRateApi' as const),
  getUsdRatesApi: mockApiFactory('getUsdRatesApi' as const),
